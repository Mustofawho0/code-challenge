...
export default function Home() {
  return (
    <div className="">
      ...
      <div className="grid grid-cols-2">
        <div className="mobile:w-[100vw] w-full pt-10 sm:w-[100vw] md:w-[75vw] md:px-[100px] lg:w-[70vw] xl:w-[65vw]">
          ...
          <p className="pt-4 text-justify">
            ...
            wadah khusus yang di dedikasikan di bidang Sumber Daya Manusia (SDM)
            dengan tujuan merumuskan wawasan strategis bagi pengembangan sumber
            daya manusia di Indonesia, terutama dalam lingkup Badan Usaha Milik
            Negara (BUMN). FHCI berawal pada tahun 2006 ketika Kementerian BUMN
            menginisiasi pertemuan seluruh Direktur Sumber Daya Manusia dari
            tanggal 11 hingga 13 November 2006 di Bali dengan tema "Sumber Daya
            Manusia BUMN sebagai Penentu Daya Saing Indonesia". FHCI resmi
            didirikan pada tanggal 8 Juni 2007.
          </p>
          <br />
          <p className="text-justify">
            Ketua umum FHCI saat ini dijabat oleh Alexandra Askandar (2021 -
            2024). Beberapa ketua umum sebelumnya adalah Ketua Umum FHCI pertama
            - Achmad Purwono (2007-2010), diikuti oleh Rukmi Hadihartini
            (2010-2012), Priyantono Rudito (2012-2015), Herdy Harman
            (2015-2021). Di bawah kepengurusan Alexandra, FHCI berkembang
            memiliki 2 sayap organisasi yaitu Srikandi BUMN dan BUMN Muda. FHCI
            juga mendirikan Lembaga Sertifikasi Profesi (LSP HCMI) pada tahun
            2020 dan Lembaga Pelatihan (LPK FHCI) di tahun 2022. Kiprah FHCI
            selama ini sangat signifikan mewarnai dunia Human Capital Indonesia.
            Hadir dengan berbagai program unggulan antara lain:
          </p>
          <br />
          <p className="text-justify">
          ...
          <p className="text-justify">
            ...
            memfasilitasi mahasiswa untuk melakukan praktik kerja di Perusahaan
            BUMN, terdapat 3 jenis magang yaitu (Magang Umum, Magang Santri, dan
            Indonesia Global Talent Internship atau magang mahasiswa yang
            berasal dari Universitas luar negeri ke perusahaan BUMN).
          </p>
          <br />
          <p className="text-justify">
            ...
            didedikasikan untuk memperkuat kapabilitas HUman Capital Indonesia.
            Event yang selalu menghadirkan nara sumber C-level global di bidang
            human capital, direksi BUMN dan perusahaan mutltinasional serta
            swasta dan akademisi.
          </p>
          <br />
          <p className="text-justify">
            4. School of Chief Human Resource Officer (CHRO) adalah Program yang
            berkolaborasi dengan Kementerian BUMN & BUMN School of Excellence
            (BSE) dalam menunjang transformasi BUMN dari sisi Human Capital.
          </p>
          <br />
          <p className="text-justify">
          ...
          <p className="text-justify">
            ...
            berkolaborasi dengan Kementerian BUMN, dalam memperkenalkan BUMN ke
        ...
        <div className="mobile:hidden ml-[190px] flex w-[35vw] items-center justify-start sm:hidden md:ml-[110px] md:flex lg:ml-[150px] xl:ml-[190px]">
          <Image
      ...
      <div className="flex items-end justify-between gap-3 py-7 md:px-[100px]">
        <h1 className=" w-[220px] text-xl font-extrabold ">Program Unggulan</h1>
        <hr className="w-full border-b border-black" />
      </div>
      <div className="flex items-end justify-end py-4 md:px-[100px]">
        <button className="flex h-[40px] w-[160px] items-center justify-center rounded-br-3xl rounded-tl-3xl border-2 border-red-500 bg-red-600 text-white">
          Lihat Program <MdArrowOutward size={30} className="pl-3" />
        </button>
      </div>
      <div className="flex items-end justify-between gap-3 py-4 md:px-[100px]">
        ...
        <div className="mobile:grid-cols-1 grid gap-2 py-5 text-justify md:grid-cols-2 md:px-[100px] lg:grid-cols-2 xl:grid-cols-4">
          <div className="max-w-xs rounded-lg border-2 bg-blue-100 hover:border-red-700">
            <Link href={"#"}>
              ...
              <p className="px-4 py-2 text-xs text-gray-600">
                ...
                strategis antara Forum Human Capital Indonesia (FHCI) dan
          ...
          <div className="max-w-xs rounded-lg border-2 bg-blue-100 hover:border-red-700">
            <Link href={"#"}>
              ...
              <p className="px-4 py-2 text-xs text-gray-600">
                ...
                Badan Usaha Milik Negara (BUMN) melalui Program Rekrutmen
                Bersama BUMN (RBB).
              </p>
              <div className="flex items-end justify-end px-10 py-3">
                <button className=" flex items-center justify-end text-xs text-red-700">
          ...
          <div className="max-w-xs rounded-lg border-2 bg-blue-100 hover:border-red-700">
            <Link href={"#"}>
              ...
              <p className="title-card px-4 text-xs font-extrabold">
                Peringati Hari Ibu, Srikandi BUMN beri dukungan terhadap
              ...
              <p className="px-4 py-2 text-xs text-gray-600">
                ...
                Merdeka Timur, Jakarta Pusat ini dihadiri lebih dari 500
                Srikandi BUMN.
              </p>
              <div className="flex items-end justify-end px-10 py-3">
                <button className=" flex items-center justify-end text-xs text-red-700">
          ...
          <div className="max-w-xs rounded-lg border-2 bg-blue-100 hover:border-red-700">
            <Link href={"#"}>
              ...
              <p className="px-4 py-2 text-xs text-gray-600">
                ...
                kesempatan bagi putra-putri terbaik bangsa untuk bergabung
                menjadi bagian dari Badan Usaha Milik Negara (BUMN) melalui
                Program RBB 2023. Program ini menjadi komitmen nyata BUMN yang
                secara konsisten mendukung penciptaan lapangan kerja nasional.
                Bahkan pada RBB 2023, kesempatan tersebut terbuka semakin luas
                karena menjangkau lintas entitas (BUMN, Anak Perusahaan BUMN,
                dan Cucu Perusahaan BUMN), jenjang pendidikan yang semakin
                beragam (SMA/SMK/sederajat s.d. S2), serta status pekerjaan baik
      ...
      <div className=" py-5 md:px-[100px]">
        <button className="flex h-[40px] w-[160px] items-center justify-center rounded-br-3xl rounded-tl-3xl border-2 border-red-500 bg-red-600 text-white">
      ...
      <div className="bg-gray-100 py-5">
        <div className=" h-auto">
          <div className="flex flex-row-reverse items-end justify-between gap-3 py-4 md:px-[100px]">
      ...
      <div className="flex items-end justify-between gap-3 py-10 md:px-[100px]">
